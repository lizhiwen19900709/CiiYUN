# WARNING
If you started running CiiYUN  from before to [2019.06.21](https://github.com/lizhiwen19900709/CiiYUN ), actions that recreate the `CiiYUN ` container (including `docker-compose up ...` under some circumstances) will result in losing access to user media files (e.g. responses to photo questions). Safely stored media files can be found in `CiiYUN/.vols/kobocat_media_uploads/`.
